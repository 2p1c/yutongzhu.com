...
Agents don't seem that profound—context injection, session management, structured tool calls, deciding when to stop and return a message to the user. That's about it, isn't it? Let me try it myself. (I'm definitely going to eat my words.)
